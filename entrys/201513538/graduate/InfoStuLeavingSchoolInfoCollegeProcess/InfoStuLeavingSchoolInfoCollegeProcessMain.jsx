...
function Boot()
{
    ...
    render(
        <div>
            <div>
                <div className="highLight" style={{height:"300px",position:"relative",backgroundColor:"transparent",marginBottom:"120px"}}>
                    <div className="left"
                         style={{paddingLeft:"50px",paddingRight:"50px",position:"absolute",float:"left",backgroundColor: "transparent",height: "100%",textAlign:"center"}}>
                        <div className="component">
                            ...
                            <tr>
                                <td className="main" height={25} style={{borderTop:"none",textAlign:"left" }}>
                                    ...
                                    <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(2)“毕业正式卡转校友卡使用”： 毕业生离校后，如果还需要回校使用校园卡，此选项可将正式卡转为临时卡使用，余额留在校园卡内不变。按学校规定，临时卡将在每次存款时，加收15%的管理费，（转卡时的余额不扣管理费）。信息办将于7月1~3日为同学们办理转卡手续，7月5日以后，选择此项的同学可以到圈存机上，做“毕业转卡”操作，将卡片转为临时卡继续使用，卡片有效期延至2017年6月1日，到期后本人携带身份证到充值点办理延期手续，一次延期一年。详细使用说明，同学们可到充值点免费领取《山东大学校园临时卡使用手册》。
