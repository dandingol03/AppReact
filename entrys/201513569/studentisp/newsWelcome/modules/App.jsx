                ...
                <div className="keyNavigation">
                    <div className="top">
                        ...
                        <div className="block center">
                            <div className="briefInformation">
                                <ul>
                                    <li>您有n条公告 <Link to={window.App.getAppRoute()+"/news"}>更多》</Link></li>
                                    <li>您有m条通知 <Link to={window.App.getAppRoute()+"/news"}>更多》</Link></li>
                                </ul>
                            </div>
                        </div>
                        <div className="block">
                    ...
                    <div className="bottom">
                        <div className="commonFunction">
                            <div className="block one">
                                <div className="functionalAreas">
                                    <a href="#" onclick="LinkClickFunction(this)">
                                        <img src={Deploy.getResourceDeployPrefix()+"/"+"images/function1.png"}
                                             alt="功能1"></img>
                                    </a>
                            ...
                            <div className="block two">
                                <div className="functionalAreas">
                                    <a href="#" onclick="LinkClickFunction(this)">
                                        <img src={Deploy.getResourceDeployPrefix()+"/"+"images/function2.png"}
                                             alt="功能1"></img>
                                    </a>
                            ...
                            <div className="block three">
                                <div className="functionalAreas">
                                    <a href="#" onclick="LinkClickFunction(this)">
                                        <img src={Deploy.getResourceDeployPrefix()+"/"+"images/function3.png"}
                                             alt="功能1"></img>
                                    </a>
                            ...
                            <div className="block four">
                                <div className="functionalAreas">
                                    <a href="#" onclick="LinkClickFunction(this)">
                                        <img src={Deploy.getResourceDeployPrefix()+"/"+"images/function4.png"}
                                             alt="功能1"></img>
                                    </a>
